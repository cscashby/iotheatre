...
#define SW_RX            21 // TMC2208/TMC2224 SoftwareSerial receive pin
#define SW_TX            22 // TMC2208/TMC2224 SoftwareSerial transmit pin
...
SERIAL_PORT.begin(115200, SERIAL_8N1, SW_RX, SW_TX);      // HW UART drivers with ESP32 redirect
